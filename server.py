...
@app.get("/heatmap", response_class=HTMLResponse, include_in_schema=False)
@app.get("/heatmap.html", response_class=HTMLResponse, include_in_schema=False)
async def heatmap():
    return _read_html("heatmap.html")
